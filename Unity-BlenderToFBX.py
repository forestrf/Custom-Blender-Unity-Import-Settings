...
print("Finished blender to FBX conversion (ASH KATCHAP modified version to match default export version. Needed because UVs weren't always imported since Unity 2020) " + outfile)
